...
- GPU detection: virtio-gpu / QEMU / VMware SVGA force software rendering to avoid crash loop (MODE_CREATE_DUMB EACCES). Real GPUs unchanged. Opt-out via XIBOPLAYER_FORCE_GPU=1.
